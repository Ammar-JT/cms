...
- Soft delete means you don't really delete it, you just put it in the trash
...
//----------------------------------------------------------------------------
//                          Many to Many Relationship + attach() + sync() + detatch()
//----------------------------------------------------------------------------
/*
...
- use $post->tags()->detach(); in PostsController@destroy to delete the post and all the post_tag related records in the pivot table
